...
design_libs=(xilinx_vip xpm axi_infrastructure_v1_1_0 axi_vip_v1_1_14 zynq_ultra_ps_e_vip_v1_0_14 xil_defaultlib lib_cdc_v1_0_2 proc_sys_reset_v5_0_13 xlconstant_v1_1_7 smartconnect_v1_0 axi_register_slice_v2_1_28)
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.prototipo_1 xil_defaultlib.glbl -o prototipo_1_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./prototipo_1_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/dolv07/gemm-beto-kv260/hw_design/vivado/gemm_beto_kv260/gemm_beto_kv260.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key prototipo_1_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc prototipo_1_simv.daidir vcs_lib c.obj)
