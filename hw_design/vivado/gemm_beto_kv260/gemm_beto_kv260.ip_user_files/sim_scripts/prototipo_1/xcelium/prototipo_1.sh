...
#
# Script generated by Vivado on Fri Mar 13 12:19:41 -05 2026
# SW Build 3865809 on Sun May  7 15:04:56 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : prototipo_1.sh
...
#
# Usage        : prototipo_1.sh
#                prototipo_1.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                prototipo_1.sh [-reset_run]
#                prototipo_1.sh [-reset_log]
#                prototipo_1.sh [-help]
#
...
#                script (type 'prototipo_1.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname axi_infrastructure_v1_1_0 -libname axi_vip_v1_1_14 -libname zynq_ultra_ps_e_vip_v1_0_14 -libname xil_defaultlib -libname lib_cdc_v1_0_2 -libname proc_sys_reset_v5_0_13 -libname xlconstant_v1_1_7 -libname smartconnect_v1_0 -libname axi_register_slice_v2_1_28 -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm axi_infrastructure_v1_1_0 axi_vip_v1_1_14 zynq_ultra_ps_e_vip_v1_0_14 xil_defaultlib lib_cdc_v1_0_2 proc_sys_reset_v5_0_13 xlconstant_v1_1_7 smartconnect_v1_0 axi_register_slice_v2_1_28)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "prototipo_1.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./prototipo_1.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"$ref_dir/../../../../gemm_beto_kv260.gen/sources_1/bd/prototipo_1/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../gemm_beto_kv260.gen/sources_1/bd/prototipo_1/ipshared/f805/hdl" +incdir+"$ref_dir/../../../../gemm_beto_kv260.gen/sources_1/bd/prototipo_1/ipshared/f0b6/hdl/verilog" +incdir+"$ref_dir/../../../../gemm_beto_kv260.gen/sources_1/bd/prototipo_1/ipshared/66be/hdl/verilog" +incdir+"../../../../gemm_beto_kv260.gen/sources_1/bd/prototipo_1/ipshared/ec67/hdl" +incdir+"../../../../gemm_beto_kv260.gen/sources_1/bd/prototipo_1/ipshared/f805/hdl" +incdir+"../../../../gemm_beto_kv260.gen/sources_1/bd/prototipo_1/ip/prototipo_1_gemm_int8_0_1/drivers/gemm_int8_v1_0/src" +incdir+"../../../../gemm_beto_kv260.gen/sources_1/bd/prototipo_1/ipshared/f0b6/hdl/verilog" +incdir+"../../../../gemm_beto_kv260.gen/sources_1/bd/prototipo_1/ipshared/66be/hdl/verilog" +incdir+"/opt/Xilinx-2023.1/Vivado/2023.1/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.prototipo_1 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.prototipo_1 -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/dolv07/gemm-beto-kv260/hw_design/vivado/gemm_beto_kv260/gemm_beto_kv260.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log prototipo_1_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./prototipo_1.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: prototipo_1.sh [-help]\n\
Usage: prototipo_1.sh [-step]\n\
Usage: prototipo_1.sh [-lib_map_path]\n\
Usage: prototipo_1.sh [-reset_run]\n\
Usage: prototipo_1.sh [-reset_log]\n\
Usage: prototipo_1.sh [-keep_index]\n\
Usage: prototipo_1.sh [-noclean_files]\n\n\
