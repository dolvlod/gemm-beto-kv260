set moduleName gemm_int8_Pipeline_load_X_VITIS_LOOP_30_1
set isTopModule 0
...
set C_modelName {gemm_int8_Pipeline_load_X_VITIS_LOOP_30_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem0 int 8 regular {axi_master 0}  }
	{ X int 64 regular  }
	{ Xbuf int 8 regular {array 49152 { 3 0 } 0 1 }  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 8, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "X","offset": { "type": "dynamic","port_name": "X","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "Xbuf", "interface" : "memory", "bitwidth" : 8, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ Xbuf_address1 sc_out sc_lv 16 signal 2 } 
	{ Xbuf_ce1 sc_out sc_logic 1 signal 2 } 
	{ Xbuf_we1 sc_out sc_logic 1 signal 2 } 
	{ Xbuf_d1 sc_out sc_lv 8 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "Xbuf_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "Xbuf", "role": "address1" }} , 
 	{ "name": "Xbuf_ce1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "Xbuf", "role": "ce1" }} , 
 	{ "name": "Xbuf_we1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "Xbuf", "role": "we1" }} , 
 	{ "name": "Xbuf_d1", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "Xbuf", "role": "d1" }}  ]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "49155", "Max" : "49155"}
	, {"Name" : "Interval", "Min" : "49155", "Max" : "49155"}
]}
...
set Spec2ImplPortList { 
	...
	Xbuf { ap_memory {  { Xbuf_address1 MemPortADDR2 1 16 }  { Xbuf_ce1 MemPortCE2 1 1 }  { Xbuf_we1 MemPortWE2 1 1 }  { Xbuf_d1 MemPortDIN2 1 8 } } }
}
