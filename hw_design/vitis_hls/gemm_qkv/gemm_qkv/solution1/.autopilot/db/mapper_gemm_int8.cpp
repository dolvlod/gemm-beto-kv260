...
using hls::sim::Byte;
extern "C" void gemm_int8(Byte<1>*, Byte<1>*, Byte<4>*, int, int, int);
extern "C" void apatb_gemm_int8_hw(volatile void * __xlx_apatb_param_X, volatile void * __xlx_apatb_param_W, volatile void * __xlx_apatb_param_Y) {
...
__xlx_X__tmp_vec.push_back(((Byte<1>*)__xlx_apatb_param_X)[i]);
  ...
  int __xlx_size_param_X = 49152;
  int __xlx_offset_param_X = 0;
  int __xlx_offset_byte_param_X = 0*1;
  // Collect __xlx_W__tmp_vec
std::vector<Byte<1>> __xlx_W__tmp_vec;
for (size_t i = 0; i < 589824; ++i){
__xlx_W__tmp_vec.push_back(((Byte<1>*)__xlx_apatb_param_W)[i]);
}
  int __xlx_size_param_W = 589824;
...
__xlx_Y__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_Y)[i]);
  ...
  int __xlx_size_param_Y = 49152;
  int __xlx_offset_param_Y = 0;
  int __xlx_offset_byte_param_Y = 0*4;
  // DUT call
  gemm_int8(__xlx_X__tmp_vec.data(), __xlx_W__tmp_vec.data(), __xlx_Y__tmp_vec.data(), __xlx_offset_byte_param_X, __xlx_offset_byte_param_W, __xlx_offset_byte_param_Y);
...
((Byte<1>*)__xlx_apatb_param_W)[i] = __xlx_W__tmp_vec[__xlx_offset_param_W+i];
}
