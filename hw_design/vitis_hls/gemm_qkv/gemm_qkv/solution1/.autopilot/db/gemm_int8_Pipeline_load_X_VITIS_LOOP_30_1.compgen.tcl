...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename Xbuf \
    op interface \
    ports { Xbuf_address1 { O 16 vector } Xbuf_ce1 { O 1 bit } Xbuf_we1 { O 1 bit } Xbuf_d1 { O 8 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'Xbuf'"
}
}
