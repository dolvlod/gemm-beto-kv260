...
# 
# ==============================================================
set ::env(LD_LIBRARY_PATH) /opt/Xilinx-2023.1/Vitis_HLS/2023.1/lnx64/tools/fpo_v7_1:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /opt/Xilinx-2023.1/Vitis_HLS/2023.1/lnx64/tools/fft_v9_1:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /opt/Xilinx-2023.1/Vitis_HLS/2023.1/lnx64/tools/fir_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /opt/Xilinx-2023.1/Vitis_HLS/2023.1/lnx64/tools/dds_v6_0:$::env(LD_LIBRARY_PATH)
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "gemm_int8.autotvin.dat"
	set constFileTvOut       "gemm_int8.autotvout.dat"
	set constFileHdlTvIn     "gemm_int8.autohdltvin.dat"
	set constFileHdlTvOut    "gemm_int8.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
