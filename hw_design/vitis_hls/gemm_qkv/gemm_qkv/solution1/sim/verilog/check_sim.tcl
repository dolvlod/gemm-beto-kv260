...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.gemm_int8.autotvin_gmem0.dat"
         "c.gemm_int8.autotvin_gmem1.dat"
         "c.gemm_int8.autotvin_X.dat"
         "c.gemm_int8.autotvin_W.dat"
         "c.gemm_int8.autotvin_Y.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.gemm_int8.autotvout_gmem2.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
