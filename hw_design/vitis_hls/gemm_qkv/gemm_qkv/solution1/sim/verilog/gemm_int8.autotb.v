...
`define AUTOTB_DUT      gemm_int8
`define AUTOTB_DUT_INST AESL_inst_gemm_int8
`define AUTOTB_TOP      apatb_gemm_int8_top
`define AUTOTB_LAT_RESULT_FILE "gemm_int8.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "gemm_int8.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_gemm_int8_top
...
`define AUTOTB_TVIN_gmem0_out_wrapc  "../tv/rtldatafile/rtl.gemm_int8.autotvin_gmem0.dat"
`define AUTOTB_TVIN_gmem1_out_wrapc  "../tv/rtldatafile/rtl.gemm_int8.autotvin_gmem1.dat"
`define AUTOTB_TVIN_X_out_wrapc  "../tv/rtldatafile/rtl.gemm_int8.autotvin_X.dat"
`define AUTOTB_TVIN_W_out_wrapc  "../tv/rtldatafile/rtl.gemm_int8.autotvin_W.dat"
`define AUTOTB_TVIN_Y_out_wrapc  "../tv/rtldatafile/rtl.gemm_int8.autotvin_Y.dat"
`define AUTOTB_TVOUT_gmem2  "../tv/cdatafile/c.gemm_int8.autotvout_gmem2.dat"
`define AUTOTB_TVOUT_gmem2_out_wrapc  "../tv/rtldatafile/rtl.gemm_int8.autotvout_gmem2.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 9;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 2945582;
parameter LENGTH_W = 1;
parameter LENGTH_X = 1;
parameter LENGTH_Y = 1;
parameter LENGTH_gmem0 = 49152;
parameter LENGTH_gmem1 = 589824;
parameter LENGTH_gmem2 = 49152;
