...
if {[file isfile gemm_int8.autotvin.dat]} {
	file delete -force gemm_int8.autotvin.dat
}

if {[file isfile gemm_int8.autotvout.dat]} {
	file delete -force gemm_int8.autotvout.dat
}
